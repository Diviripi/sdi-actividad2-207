module.exports = function (app, swig, gestorBD) {
    ...
    app.get('/store', function (req, res) {
        app.get("logger").debug("Accediendo a la tienda")
        let criterio = {};
    ...
    app.get('/offers/removeOffer/:id', function (req, res) {
        app.get("logger").debug("Borrando oferta")
    ...
    app.get('/offers/buyOffer/:id', function (req, res) {
        app.get("logger").debug("Comprando oferta")
    ...
    app.get('/user/offers', function (req, res) {
        app.get("logger").debug("Ofertas propias")
    ...
    app.get("/user/offers/bought",function(req,res){
        app.get("logger").debug("Ofertas compradas")
